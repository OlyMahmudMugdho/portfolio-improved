        ...
        <div>
            <header className="md:shadow-lg">
                <div>
                    ...
                    <div className="md:hidden flex justify-end items-center font-bold text-3xl md:py-0 md:pr-0 pr-4 py-1 bg-slate-900 text-white logo pb-0 m-0">
                        Oly
                    </div>
                </div>
                <nav className={classHidden}>
                    ...
                    <div className="md:flex" onScroll={scrollHandler}>
                        <ul className="md:flex md:mr-28 md:font-semibold md:flex-row flex flex-col justify-center items-center  md:justify-between  md:bg-white bg-slate-900 md:text-slate-900 text-white md:text-xl text-xl">
                            ...
                            <li className="flex"><Link className="md:px-4 py-2 md:py-4 md:text-xl md:hover:text-cyan-600 md:hover:underline md:underline-offset-8  md:w-full md:text-slate-900" to="http://localhost:3000/#about" >About</Link></li>
