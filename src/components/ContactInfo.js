    ...
    return (
        <div className="flex flex-col justify-center md:ml-32 md:pl-8 text-2xl m-auto">
            <div className="flex flex-col justify-center py-10">
                <p className="flex mb-8 items-center">
                    <FontAwesomeIcon icon={faEnvelope} className="text-4xl text-teal-700" />
                ...
                <p className="flex mb-8">
                    <FontAwesomeIcon icon={faLocationDot} className="text-4xl text-teal-700" />
